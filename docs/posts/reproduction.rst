...
.. [#P2] Approximating discrimination within models when faced with several non-binary sensitive attributes (arXiv preprint `2408.06099 <https://arxiv.org/pdf/2408.06099>`_)
.. [#P1] Measuring model-induced discrimination via efficient fairness approximation (arXiv preprint `2405.09251 <https://arxiv.org/pdf/2405.09251>`_, doi `10.1109/TNNLS.2026.3706648 <https://doi.org/10.1109/TNNLS.2026.3706648>`_)
